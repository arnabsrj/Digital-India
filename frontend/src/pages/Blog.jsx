        ...
        <img
          src={
            image.startsWith("http")
              ? image
              : `https://digital-india-backend-unnn.onrender.com${image}`
          }
          alt={title}
          style={{
            width: "100%",
        ...
        <aside className="bl-sidebar">
          ...
          <div className="bl-sidebar-widget">
            ...
            <div className="bl-sidebar-share-links">
              <a href="#" className="bl-share-link-block">
                <MailIcon /> Email This
              </a>
              <a href="#" className="bl-share-link-block">
                <LinkIcon /> Share to X
