...
const WifiIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.288 15.038C7.226 14.008 7 12.55 7 11c0-1.55.226-3.008 1.288-4.038M15.712 15.038C16.774 14.008 17 12.55 17 11c0-1.55-.226-3.008-1.288-4.038M12 18a.969.969 0 00.969-.969V17.03a.969.969 0 00-.969-.969A.969.969 0 0011.03 17.03v.001A.969.969 0 0012 18z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M19.416 18.892a11.04 11.04 0 00-14.832 0M21.71 21.19a15.083 15.083 0 00-19.42 0"
    />
  </svg>
);
const BatteryIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M21 10.5h.375c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125H21M4.5 10.5h15V15H4.5v-4.5zM3.75 18h16.5v-2.25A1.125 1.125 0 0019.125 15H4.875A1.125 1.125 0 003.75 16.125V18zM3 9.75h18v-3A1.125 1.125 0 0019.875 5.625H4.125A1.125 1.125 0 003 6.75v3z"
    />
  </svg>
);
        ...
        <section className="cr-main-content">
          ...
          <section className="jn-form-section">
            ...
            <form className="jn-form" onSubmit={handleSubmit}>
              ...
              <div className="jn-form-group-full">
                <button type="submit" className="jn-submit-btn">
                  Submit
                </button>
              </div>
            </form>
          ...
          <section id="contact-info" className="cr-section cr-contact-info">
            ...
            <div>
              ...
              <p>Hobli, Outer Ring Road Bellandur, Bangalore,</p>
